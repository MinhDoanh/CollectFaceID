...
with st.spinner('Student Attendance System is in force...'):
    time.sleep(1.8)

col_1, col_2 = st.columns([2.6, 5])

with col_1:
    st.image(f'./face_recognition_dynamic.gif', caption='Hệ thống điểm danh khuôn mặt sử dụng công nghệ trí tuệ nhân tạo AI')
...
with col_2:
    ...
    st.write("Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's "
             ...
             "of Lorem Ipsum.")
    st.info('2. Quản lý định danh sinh viên')
    st.write("Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin "
    ...
    st.info('3. Tiền xử lý, huấn luyện mô hình, xem CSDL định danh sinh viên')
    st.write('It is a long established fact that a reader will be distracted by the readable content of a page when looking at '
